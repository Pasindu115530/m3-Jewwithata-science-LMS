    ...
    <main className="grid min-h-screen place-items-center p-4">
      <div className="soft-panel grid w-full max-w-5xl overflow-hidden lg:grid-cols-2">
        ...
        <div className="p-7 md:p-12">
          ...
          <p className="mt-10 text-sm font-extrabold uppercase tracking-[.18em] text-lavender-600">Student Login</p>
          <h2 className="mt-3 text-3xl font-black">Sign in to your portal</h2>
          <p className="mt-2 text-sm text-ink/50">Enter your student credentials to access your portal.</p>
