...
export const classes = [
  { grade: "Grade 6", title: "Science Foundation", fullTitle: "06 ශ්‍රේණිය (Grade 6 Science)", day: "Friday", time: "3:30 PM – 5:30 PM", mode: "Physical", location: "Maharagama", fee: "LKR 2,200", seats: 16, titleImage: "/images/courses/g6title.avif",
  ...
  { grade: "Grade 7", title: "Science Explorer", fullTitle: "07 ශ්‍රේණිය (Grade 7 Science)", day: "Thursday", time: "4:00 PM – 6:00 PM", mode: "Physical", location: "Maharagama", fee: "LKR 2,400", seats: 18, titleImage: "/images/courses/g7title.avif",
    paperClass: { name: "Smart Science Paper Class", status: "Active", schedule: "සඳුදා ප.ව 8.00 (Monday 8.00 PM)" },
    theoryClass: { name: "Smart Science Theory Class", status: "Coming Soon", note: "දේශන කාලසටහන ළඟදීම බලාපොරොත්තුවන්න." } },
  { grade: "Grade 8", title: "Science Theory", fullTitle: "08 ශ්‍රේණිය (Grade 8 Science)", day: "Monday", time: "4:00 PM – 6:00 PM", mode: "Physical", location: "Nugegoda", fee: "LKR 2,500", seats: 14, titleImage: "/images/courses/g8title.avif",
    paperClass: { name: "Smart Science Paper Class", status: "Active", schedule: "ඉරිදා ප.ව 8.00 (Sunday 8.00 PM)" },
    theoryClass: { name: "Smart Science Theory Class", status: "Coming Soon", note: "දේශන කාලසටහන ළඟදීම බලාපොරොත්තුවන්න." } },
  { grade: "Grade 9", title: "Revision + Papers", fullTitle: "09 ශ්‍රේණිය (Grade 9 Science)", day: "Wednesday", time: "5:00 PM – 7:00 PM", mode: "Online", location: "Zoom", fee: "LKR 2,800", seats: 21, titleImage: "/images/courses/g9title.avif",
    paperClass: { name: "Smart Science Paper Class", status: "Active", schedule: "බදාදා ප.ව 6.30 (Wednesday 6.30 PM)" },
    theoryClass: { name: "Smart Science Theory Class", status: "Coming Soon", note: "දේශන කාලසටහන ළඟදීම බලාපොරොත්තුවන්න." } },
  { grade: "Grade 10", title: "O/L Science", fullTitle: "10 ශ්‍රේණිය (Grade 10 Science)", day: "Saturday", time: "8:30 AM – 11:00 AM", mode: "Physical", location: "Maharagama", fee: "LKR 3,200", seats: 8, titleImage: "/images/courses/g10title.avif",
    paperClass: { name: "Smart Science Paper Class", status: "Active", schedule: "සෙනසුරාදා පෙ.ව 8.30 (Saturday 8.30 AM)" },
    theoryClass: { name: "Smart Science Theory Class", status: "Coming Soon", note: "දේශන කාලසටහන ළඟදීම බලාපොරොත්තුවන්න." } },
  { grade: "Grade 11", title: "Final Paper Class", fullTitle: "11 ශ්‍රේණිය (Grade 11 Science)", day: "Sunday", time: "1:30 PM – 4:30 PM", mode: "Hybrid", location: "Maharagama + Zoom", fee: "LKR 3,500", seats: 5, titleImage: "/images/courses/g11title.avif",
